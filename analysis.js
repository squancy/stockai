  ...
  xml.onreadystatechange = function() {
    if (xml.readyState == 4 && xml.status == 200) {
      ...
      for (let i = 0; i < tmp.length; i++) {
        ...
        let dataArr = Object.keys(json.imgdata.data).map(i => json.imgdata
          .data[i]);
        ...
        */
        ...
        if ((mOne <= 100 && mTwo <= 100 && mThree > 100 && mThree < 105) ||
          (mOne <= 100 && mTwo > 100 && mTwo <= 105 && mThree > 100 &&
            mThree <= 105)) {
          momText = "<span class='overbought'>Strong buy</span> (" +
            momentum.join(", ") + ")";
          pointsBuy += 2;
        } else if ((mOne > 100 && mTwo > 100 && mThree < 100 && mThree >=
          95) ||
          (mOne > 100 && mTwo < 100 && mTwo >= 95 && mThree < 100 && mThree >=
            95)) {
        ...
        if ((ema3One < close && ema3Two < close && ema3Three >= close) ||
          ...
          ema3Text = "<span class='overbought'>Strong Buy </span> (" +
            ema3Last + ")";
          pointsBuy += 2;
        } else if ((ema3One > close && ema3Two <= close && ema3Three <=
          close) ||
          (ema3One > close && ema3Two > close && ema3Three <= close)) {
          ema3Text = "<span class='oversold'>Strong Sell</span> (" +
            ema3Last + ")";
          pointsSell += 2;
        } else {
        ...
        if ((ema9One < close && ema9Two < close && ema9Three >= close) ||
          ...
          ema9Text = "<span class='overbought'>Strong Buy</span> (" +
            ema9Last + ")";
          pointsBuy += 2;
        } else if ((ema9One > close && ema9Two <= close && ema9Three <=
          close) ||
          (ema9One > close && ema9Two > close && ema9Three <= close)) {
          ema9Text = "<span class='oversold'>Strong sell</span> (" +
            ema9Last + ")";
          pointsSell += 2;
        } else {
        ...
        if ((ema14One < close && ema14Two < close && ema14Three >= close) ||
          ...
          ema14Text = `
                    ...
                    `;
          pointsBuy += 2;
        } else if ((ema14One > close && ema14Two <= close && ema14Three <=
            close) ||
          (ema14One > close && ema14Two > close && ema14Three <= close)) {
          ema14Text = `
        ...
        if (closeBefore > close) {
          ...
          bigPrice = "<span class='oversold'>" + close + " (" + percent +
            "%)</span>";
...
function analyzeStock(data) {
  return [RSI(data, 14), momentum(data, 14), stochastic(data, 6), movingAvg(
      data, 3, "ema"),
...
function momentum(data, n) {
  ...
  */
  ...
  for (let i = 0; i < 3; i++) {
    ...
    let e = ((todayClose - nBeforeClose) / (nBeforeClose) * 100 + 100).toFixed(
      2);
    result.push(e);
  }
