...
<body>
    ...
    <div class="hStocks nonStockCont">
        <div class="stockCont infoHolder" style="border-radius: 5px;">
            ...
            <p>&emsp;&emsp;<a href="/test.php" download="test.php">index.php</a> (22 KB)</p>
            ...
            <p>&emsp;&emsp;<a href="/template_pageBottom.php" download="template_pageBottom.php">template_pageBottom.php</a> (681 B)</p>
            <p>&emsp;&emsp;<a href="/style/style_ai.css" download="style.css">style.css</a> (1.9 KB)</p>
            <p>&emsp;&emsp;<a href="/images/favstock.png" download="favstock.png">favicon.png</a> (316 B)</p>
            <p>&emsp;&emsp;<a href="/images/rolling.gif" download>rolling.gif</a> (17 KB)</p>
            <p>&emsp;&emsp;<a href="/curl.php" download>curl.php</a> -- optional (1.6 KB)</p>

            <b>&emsp;1.2 Download files as a .tar or .zip file</b>
            <p>&emsp;&emsp;<a href="/stockai.tar">stockai.tar</a> (128 KB)</p>
            <p>&emsp;&emsp;<a href="/stockai.zip">stockai.zip</a> (48 KB)</p>
            <b>&emsp;1.3 Visit the GitHub repository</b>
            <p>&emsp;&emsp;Contribute to Stock AI via <a href="">GitHub</a>.</p>
        </div>
    </div>
</body>
